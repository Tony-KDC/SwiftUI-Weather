        ...
        ZStack {
            ...
            VStack{
                ...
                HStack(spacing:20){
                    ...
                    WeatherDayView(dayOfWeek: "THU", imageName: "cloud.sun.fill", temperature: 55)
                    
                    WeatherDayView(dayOfWeek: "FRI", imageName: "wind.snow", temperature: 60)
                    
                    WeatherDayView(dayOfWeek: "SAT", imageName: "sunset.fill", temperature: 25)
                }
